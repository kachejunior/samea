...
<head>
    ...
    <script src="../js/funcionesPasajerosFactura.js" type="text/javascript"></script>
...
<body>
	...
	<div class="cuerpo">
            <div class="titulo_form">REGISTRO DE PASAJEROS</div>
            <form onsubmit="guardarPasajero(); return false;">
                ...
                <div class="datos">
                    ...
                    <input type="hidden" id="tramo" value="<?php echo $_GET['tramo'] ?>"/>
                    ...
                    <div  class="campo">
                        ...
                        <input type="text" id="telefono" maxlength="12" style="width: 150px;" required="required"
            ...
            <table class="tableta" id="pasajeros"> 
                <?php include '../ajax/listaDePasajerosFactura.php';?>
            </table>
        </div>
    </div>
